          ...
          <section className="glass-panel col-span-12 rounded-[28px] border p-6 lg:col-span-7">
            <div className="summary-panel-header">
              <div className="min-w-0">
                ...
                <h2 className="panel-title mt-2">{t('alert_scope_title')}</h2>
              </div>
            </div>
            <p className="hero-description mt-4">{t('alert_scope_desc')}</p>
            <div className="summary-row mt-6">
              <div className="min-w-0">
                ...
                <p className="summary-subvalue truncate">
                  {t('alert_active_target_desc', { count: servers.length })}
                </p>
              </div>
          ...
          <section className="glass-panel col-span-12 rounded-[28px] border p-6 lg:col-span-5">
            <div className="summary-panel-header">
              <div className="min-w-0">
                ...
                <h2 className="panel-title mt-2">{t('alert_future_title')}</h2>
              </div>
            </div>
            <div className="summary-list mt-6">
              {[t('alert_signal_threshold'), t('alert_signal_routing'), t('alert_signal_history')].map((item) => (
